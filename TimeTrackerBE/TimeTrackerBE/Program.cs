...
string swaggerTitle = "TimeTrackerBE";
...
string? connectionString = builder.Configuration.GetConnectionString("TimeTrackerPro");
...
Console.WriteLine($"******** Don't forget to comment out TimeTrackerProContext.OnConfiguring !");
Console.ResetColor();
builder.Services.AddDbContext<TimeTrackerProContext>(options => options.UseSqlServer(connectionString));
